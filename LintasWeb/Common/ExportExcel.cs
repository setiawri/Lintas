...
namespace LintasMVC.Common
{
    public class ExportExcel
    {
        ...
        public ExcelPackage ForwarderReports(List<Models.ShipmentsReportModels> list)
        {
            ...
            ws.Cells[7, 1].Value = 5; ws.Cells[7, 2].Value = "Parcel Long";
            ws.Cells[8, 1].Value = 5; ws.Cells[8, 2].Value = "Parcel Wide";
            ws.Cells[9, 1].Value = 5; ws.Cells[9, 2].Value = "Parcel High";
            ws.Cells[10, 1].Value = 5; ws.Cells[10, 2].Value = "Parcel Volume";
            ws.Cells[11, 1].Value = 5; ws.Cells[11, 2].Value = "Consignment Date";
            ws.Cells[12, 1].Value = 5; ws.Cells[12, 2].Value = "Tax Consignee Number";
            ws.Cells[13, 1].Value = 5; ws.Cells[13, 2].Value = "Consignee Name";
            ws.Cells[14, 1].Value = 5; ws.Cells[14, 2].Value = "Consignee Company";
            ws.Cells[15, 1].Value = 5; ws.Cells[15, 2].Value = "Consignee Phone";
            ws.Cells[16, 1].Value = 5; ws.Cells[16, 2].Value = "Consignee Mobile";
            ws.Cells[17, 1].Value = 5; ws.Cells[17, 2].Value = "Consignee Fax";
            ws.Cells[18, 1].Value = 5; ws.Cells[18, 2].Value = "Consignee Email";
            ws.Cells[19, 1].Value = 5; ws.Cells[19, 2].Value = "Consignee Postal Code";
            ws.Cells[20, 1].Value = 5; ws.Cells[20, 2].Value = "Consignee Country";
            ws.Cells[21, 1].Value = 5; ws.Cells[21, 2].Value = "Consignee Country Code";
            ws.Cells[22, 1].Value = 5; ws.Cells[22, 2].Value = "Consignee State";
            ws.Cells[23, 1].Value = 5; ws.Cells[23, 2].Value = "Consignee City";
            ws.Cells[24, 1].Value = 5; ws.Cells[24, 2].Value = "Consignee Address 1";
            ws.Cells[25, 1].Value = 5; ws.Cells[25, 2].Value = "Consignee Address 2";
            ws.Cells[26, 1].Value = 5; ws.Cells[26, 2].Value = "Shipper Name";
            ws.Cells[27, 1].Value = 5; ws.Cells[27, 2].Value = "Shipper Company";
            ws.Cells[28, 1].Value = 5; ws.Cells[28, 2].Value = "Shipper Phone";
            ws.Cells[29, 1].Value = 5; ws.Cells[29, 2].Value = "Shipper Mobile";
            ws.Cells[30, 1].Value = 5; ws.Cells[30, 2].Value = "Shipper Fax";
            ws.Cells[31, 1].Value = 5; ws.Cells[31, 2].Value = "Shipper Email";
            ws.Cells[32, 1].Value = 5; ws.Cells[32, 2].Value = "Shipper Postal Code";
            ws.Cells[33, 1].Value = 5; ws.Cells[33, 2].Value = "Shipper Country";
            ws.Cells[34, 1].Value = 5; ws.Cells[34, 2].Value = "Shipper Country Code";
            ws.Cells[35, 1].Value = 5; ws.Cells[35, 2].Value = "Shipper State";
            ws.Cells[36, 1].Value = 5; ws.Cells[36, 2].Value = "Shipper City";
            ws.Cells[37, 1].Value = 5; ws.Cells[37, 2].Value = "Shipper Address 1";
            ws.Cells[38, 1].Value = 5; ws.Cells[38, 2].Value = "Shipper Address 2";
            ws.Cells[39, 1].Value = 5; ws.Cells[39, 2].Value = "Parcel Quantity";
            ws.Cells[40, 1].Value = 5; ws.Cells[40, 2].Value = "Product Quantity";
            ws.Cells[41, 1].Value = 5; ws.Cells[41, 2].Value = "ProductDescription";
            ws.Cells[42, 1].Value = 5; ws.Cells[42, 2].Value = "Declaration Price";
            ws.Cells[43, 1].Value = 5; ws.Cells[43, 2].Value = "Currency";
            ws.Cells[44, 1].Value = 5; ws.Cells[44, 2].Value = "Billing Code";
            ws.Cells[45, 1].Value = 5; ws.Cells[45, 2].Value = "Billing Account";
            ws.Cells[46, 1].Value = 5; ws.Cells[46, 2].Value = "Broker Name";
            ws.Cells[47, 1].Value = 5; ws.Cells[47, 2].Value = "Broker Phone";
            ws.Cells[48, 1].Value = 5; ws.Cells[48, 2].Value = "HS Code";
            ws.Cells[49, 1].Value = 5; ws.Cells[49, 2].Value = "Freight Cost";
            ws.Cells[50, 1].Value = 5; ws.Cells[50, 2].Value = "Insurance";
            ws.Cells[51, 1].Value = 5; ws.Cells[51, 2].Value = "Bag No";
            ws.Cells[52, 1].Value = 5; ws.Cells[52, 2].Value = "Payment Type";
